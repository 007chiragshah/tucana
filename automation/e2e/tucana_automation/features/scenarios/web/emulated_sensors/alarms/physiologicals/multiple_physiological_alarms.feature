@WEB @ALARMS @SMOKE
Feature: [WEB] Multiple Physiological alarms inside the Bed details page

  @MULTIPLE @PHYSIOLOGICAL 
  @SR-1.4.1.1 @SR-1.4.1.2 @SR-1.4.1.3 @SR-1.4.1.4 @SR-1.4.1.5 @SR-1.4.1.6 @SR-1.4.1.7 @SR-1.4.1.8 @SR-1.4.1.9
  Scenario Outline: Multiple "<Alarm Type>" alerts and alarms HIGH priority
    ...
    Then Tom sees all the Cards activated with the correct color
    And Tom sees the top level indicator showing the last "<Alarm Type>" alarm name triggered and the total
    And Tom sees the left "<Alarm Type>" alarm indicator showing the total number of alarms triggered
