@WEB @SMOKE
Feature: [WEB] Emulated Sensors - DMT Thermometer Physiological Alarms inside bed details information


  @EMULATED_SENSORS @PHYSIOLOGICAL @DMT
  @SR-1.3.12.1 @SR-1.3.12.2
  @SR-1.4.1.1 @SR-1.4.1.2 @SR-1.4.1.6 @SR-1.4.1.7 @SR-1.4.1.8 @SR-1.4.1.9
  Scenario Outline: DMT Thermometer alarms - "<Alarm Position>" Alarms
    ...
    Examples:
      ...
      | PM-QA-X001 | SEN-QA-X001 | DMT Thermometer   | Physiological | Card           |
      | PM-QA-X001 | SEN-QA-X001 | DMT Thermometer   | Physiological | Top/Left       |