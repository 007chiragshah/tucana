@WEB @SMOKE
Feature: [WEB] Emulated Sensors - ANNE Chest Technical Alerts inside bed details information

  @EMULATED_SENSORS @TECHNICAL @ANNE 
  ...
  Scenario Outline: Anne Chest "<Alarms Type>" alerts, messages, colors and icons test
    ...
    primary_identifier: SEN-QA-X011
    name: ANNE Chest
    """
    ...
    Examples:
      ...
      | PM-QA-X011 | SEN-QA-X011 | ANNE Chest  | Technical     | Top/Left       |