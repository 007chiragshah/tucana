@WEB @SMOKE
Feature: [WEB] Emulated Sensors - Viatom BP monitor Physiological Alarms inside bed details information

  @EMULATED_SENSORS @PHYSIOLOGICAL @VIATOM 
  ...
  Scenario Outline: Viatom BP monitor alarms - "<Alarm Position>" Alarms
    ...
    Examples:
      ...
      | PM-QA-X001 | SEN-QA-X001 | Viatom BP monitor   | Physiological | Card           |
      | PM-QA-X001 | SEN-QA-X001 | Viatom BP monitor   | Physiological | Top/Left       |