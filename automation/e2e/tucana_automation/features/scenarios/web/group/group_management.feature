...
Feature: [WEB] Group Management
  ...
  Background:
    ...
    And Tom wants to create a new group
  	...
  	@SR-1.2.4.5 @SR-1.2.4.6 @SR-1.2.4.8 @SR-1.2.4.13 @SR-1.2.4.14 @SR-1.2.4.15 @SR-1.2.4.19 @SR-1.2.4.24 @SR-1.2.4.28 @SR-1.2.4.29 @SR-1.2.4.30 @SR-1.2.4.33 @SR-1.2.4.34 @SR-1.2.4.41 @SR-1.2.4.43
  ...
  @SR-1.2.4.7 @SR-1.2.4.8 @SR-1.2.4.19 @SR-1.2.4.24 @SR-1.2.4.28
  ...
  @SR-1.2.4.41 @SR-1.2.4.43 @SR-1.2.4.44
