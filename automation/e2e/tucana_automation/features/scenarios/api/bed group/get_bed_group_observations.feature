@API @BED_GROUP @SR-7.5.3
Feature: [API] Get Bed Group observations

  @EMULATED_SENSORS @TECHNICAL @ANNE @SR-1.3.2 @SR-1.3.7 @SR-1.3.10 @SR-1.3.22 @SR-1.5.1.1
  Scenario Outline: Get "<Alarm Type>" alerts for Bed Group
    ...
    primary_identifier: SEN-AU-X044
    name: ANNE Chest
    """
    ...
    #When Tom wants to get bed group observations
    #And Tom is told the get bed group observations request was successful
    #Then Tom verifies that the bed group observations information is correct
    ...
    Examples:
      ...
      | PM-AU-X044 |  SEN-AU-X044 | ANNE Chest  | 258098     | technical     | HI       |
      | PM-AU-X044 |  SEN-AU-X044 | ANNE Chest  | 258050     | Physiological | HI       |