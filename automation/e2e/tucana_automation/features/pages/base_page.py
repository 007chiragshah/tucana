...
class BasePage:
    ...
    incorrect_password = (By.XPATH, "//span[text()='Incorrect password. Please try again.']")
    too_many_attempts_error_msg = (By.XPATH, "//span[text()='Too many attempts. Please try again in 15 minutes.']")
