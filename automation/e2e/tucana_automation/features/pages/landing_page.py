...
class LandingPage(BasePage):
    ...
    too_many_attempts_change_password_error_msg = (
        By.XPATH,
        "//span[text()='Too many attempts. Please try again in 15 minutes.']",
    )
    form = (By.XPATH, "//form")
    log_in_description = (By.XPATH, "//h6[text()='Welcome to Central Hub']")
    ...
    def too_many_attempts_error(self):
        try:
            self.web_utils.find_element(*self.too_many_attempts_error_msg)
        except Exception:
            raise Exception("The error message pop up was not here")    

    def too_many_attempts_change_password_error(self):
        try:
            self.web_utils.find_element(*self.too_many_attempts_change_password_error_msg)
        except Exception:
            raise Exception("The error message pop up was not here") 
    ...
    def check_password_placeholder(self):
        try:
            ...
            raise Exception("Can not find the password placeholder")
    ...
    def check_log_in_title_style(self):
        try:
            ...
            styles = {"font_type": "__Open_Sans_5c127d", "font_size": "40px", "font_weight": "700", "font_color": "#ffffff"}
    ...
    def check_log_in_button_style(self):
        try:
            ...
            styles = {"font_type": "__Open_Sans_5c127d", "font_size": "24px", "font_weight": "700", "font_color": "#5c5c5c"}
    ...
    def check_button_enabled_style(self):
        try:
            ...
            button = self.web_utils.find_element(*self.form, retries=20, log_errors=False).find_element(By.XPATH, "./child::button")
            styles = {"font_type": "__Open_Sans_5c127d", "font_size": "24px", "font_weight": "700", "font_color": "#ffffff"}
            text_style = self.check_style_parameters(button,
                                        font_type=styles['font_type'],
                                        font_size=styles['font_size'],
                                        font_weight=styles['font_weight'],
