...
const TechnicalLogin = () => {
  ...
  return (
    <>
      <title>{t('TechnicalLoginPage.pageTitle')}</title>
      <Grid
        display='flex'
      ...
      >
        ...
        >
          <Typography variant='h1'>{t('TechnicalLoginPage.title')}</Typography>
        ...
        >
          ...
          <CopyrightText sx={{}} variant='caption' textAlign='center'>
            {t('TechnicalLoginPage.copyright', { year: moment().year().toString() })}
          </CopyrightText>
          <CopyrightText variant='caption' textAlign='center'>
            {t('TechnicalLoginPage.UDI', {
