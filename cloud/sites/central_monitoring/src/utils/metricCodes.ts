...
export const RANGES_CODES = {
  ...
  TEMPERATURE_SKIN_LOW: '258429',
  TEMPERATURE_SKIN_HIGH: '258430',
  TEMPERATURE_BODY: '258425',
  TEMPERATURE_BODY_LOW: '258435',
  TEMPERATURE_BODY_HIGH: '258436',
  FALLS: '8574701',
...
export const DEVICE_ALERT_CODES: AlertMetadataMapping = {
  SENSOR_CHARGING_ALERT: {
    code: 'Internal_Charging_Code',
    message: '',
    waveformMessage: 'SENSOR CHARGING. NOT ON PATIENT.',
  },
  OUT_OF_RANGE_ALERT: {
    code: '258098',
