...
const AssignBedSelectComponent = styled(Select)(() => ({
  boxShadow: 'none',
...
const BedMenuItemText = styled(Typography)(() => ({
  overflow: 'hidden',
                        ...
                        >
                          ...
                          {beds
                            ...
                            .map((bed: BedType, bedIndex: number) => (
                              ...
                              >
                                <BedMenuItemText variant='body1'>{bed.bedNo}</BedMenuItemText>
                              </MenuItem>
                            ))}
                        </AssignBedSelectComponent>
                      </FormControl>
