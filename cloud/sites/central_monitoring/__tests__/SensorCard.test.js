...
describe('SensorCard', () => {
   ...
   */
  test.each([9, 20, 49, 69, 89, 100])('renders correct battery icon', async (battery) => {
    render(
      <SensorCard
        sensorType=''
        battery={battery}
    ...
    let batteryText;
    if (battery <= 9) batteryText = 'empty';
    else if (battery <= 20) batteryText = 'low';
    else if (battery <= 49) batteryText = '40';
    else if (battery <= 69) batteryText = 'mid';
    else if (battery <= 89) batteryText = 'high';
