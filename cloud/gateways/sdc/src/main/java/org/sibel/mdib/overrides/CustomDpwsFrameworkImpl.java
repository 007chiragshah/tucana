...
public class CustomDpwsFrameworkImpl extends AbstractIdleService implements DpwsFramework {
    ...
    private final CustomHttpServerClientSelfTest httpServerClientSelfTest;

    @Inject
    CustomDpwsFrameworkImpl(
            ...
            CustomHttpServerClientSelfTest httpServerClientSelfTest) {
    ...
    private void printNetworkInterfaceInformation() throws SocketException {
        Iterator<NetworkInterface> networkInterfaceIterator =
        ...
        while (networkInterfaceIterator.hasNext()) {
            ...
            instanceLogger.debug(
                    "Found network interface: [{};isUp={};isLoopBack={},supportsMulticast={},MTU={}," + "isVirtual={}]",
                    netInterface,
                    netInterface.isUp(),
            ...
            Iterator<InetAddress> inetAddressIterator =
                    netInterface.getInetAddresses().asIterator();
            int i = 0;
    ...
    private void configureDiscovery() throws UnknownHostException, SocketException {
        ...
        try {
            ...
            instanceLogger.warn(
                    "WS-Discovery multicast port could not be retrieved as InetAddress: {}", e.getMessage());
