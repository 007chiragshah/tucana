...
public class ComponentStateChangeProcessor {
    ...
    public BrokerMessage getBatteryBrokerMessage() throws ProcessingError {
        return new MetricBrokerMessage<>(uuidProvider.get(), instantProvider.now(), getBatteryMetricPayload());
    }

    public MetricPayload<BigDecimal> getBatteryMetricPayload() throws ProcessingError {
        try {
    ...
    public BrokerMessage getBatteryChargingStatusBrokerMessage() throws ProcessingError {
        return new MetricBrokerMessage<>(uuidProvider.get(), instantProvider.now(), getChargingStatusMetricPayload());
    }

    public MetricPayload<String> getChargingStatusMetricPayload() throws ProcessingError {
        try {
            return new MetricPayload<>(
                    patientPrimaryIdentifier,
