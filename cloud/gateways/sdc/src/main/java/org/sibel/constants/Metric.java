...
public enum Metric {
    ...
    SYS("150021", UnitCodes.MERCURY_MILLIMETRES, MetricChannel.VITALS, "sys"),
    DIA("150022", UnitCodes.MERCURY_MILLIMETRES, MetricChannel.VITALS, "dia"),
    MAP("150035", UnitCodes.MERCURY_MILLIMETRES, MetricChannel.VITALS, "map"),
