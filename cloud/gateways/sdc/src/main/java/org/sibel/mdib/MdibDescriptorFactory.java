...
public final class MdibDescriptorFactory {
    ...
    public static LimitAlertConditionDescriptor createAlertConditionDescriptor(
            SensorType sensorType, TechnicalAlertCondition alert) {
        return createAlertConditionDescriptor(sensorType, alert, true);
    }

    public static LimitAlertConditionDescriptor createAlertConditionDescriptor(
            SensorType sensorType, TechnicalAlertCondition alert, boolean withSources) {
        ...
        descriptor.setMaxLimits(createMaxLimits(alert.upperLimit, alert.lowerLimit));
        return descriptor;
    }

    public static LimitAlertConditionDescriptor createAlertConditionDescriptor(PhysiologicalAlertCondition alert) {
        var descriptor = new LimitAlertConditionDescriptor();
        descriptor.setHandle(getAlertConditionHandle(alert));
        descriptor.setPriority(alert.priority);
        descriptor.setKind(AlertConditionKind.PHY);
        descriptor.setSource(alert.sources.stream()
    ...
    public static AlertSignalDescriptor createAlertSignalDescriptor(SensorType sensorType, TechnicalAlertSignal alert) {
        var descriptor = new AlertSignalDescriptor();
        descriptor.setHandle(getAlertSignalHandle(sensorType, alert));
        descriptor.setConditionSignaled(getAlertConditionHandle(sensorType, alert.condition));
        descriptor.setManifestation(AlertSignalManifestation.VIS);
        descriptor.setType(createCodedValue(alert.code, null));
        return descriptor;
    }

    public static AlertSignalDescriptor createAlertSignalDescriptor(PhysiologicalAlertSignal alert) {
        var descriptor = new AlertSignalDescriptor();
        descriptor.setHandle(getAlertSignalHandle(alert));
        descriptor.setConditionSignaled(getAlertConditionHandle(alert.condition));
