...
public final class MdibHandles {
    ...
    public static String getAlertConditionHandle(SensorType sensorType, TechnicalAlertCondition alert) {
        return String.format("%s.condition.%s", getAlertSystemHandle(sensorType), alert.handle);
    }

    public static String getAlertConditionHandle(PhysiologicalAlertCondition alert) {
        return alert.handle;
    }

    public static String getAlertSignalHandle(SensorType sensorType, TechnicalAlertSignal alert) {
        return String.format("%s.signal.vis.%s", getAlertSystemHandle(sensorType), alert.handle);
    }

    public static String getAlertSignalHandle(PhysiologicalAlertSignal alert) {
        return alert.handle;
    }
