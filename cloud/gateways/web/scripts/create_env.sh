...
# create .env file
  {
    ...
    echo "BASE_PATH=/web"
    echo "APP_DOMAIN_NAME=127.0.0.1"
    echo "AUTH_V2_ENABLED=true"
    ...
    echo "AUTH_PLATFORM_V2_BASE_URL=http://localhost:8006/auth"
    ...
    echo "DEFAULT_CLINICAL_USERNAME=admin@sibelhealth.com"
