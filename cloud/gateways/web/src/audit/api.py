...
@api.get(
    ...
    description=(
        "Retrieve the audit trail for a specific entity identified by its unique ID."
        " This includes a detailed history of changes or actions performed on the entity, "
        "such as creation, updates, deletions, or other operational events."
    ),
)
