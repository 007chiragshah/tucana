...
def update_monitor_keep_alive(monitor_id: str):
    MONITORS_KEEP_ALIVE_TIME[monitor_id] = int(time.time() * 1000)


def clear_monitor_keep_alive(monitor_id: str):
    del MONITORS_KEEP_ALIVE_TIME[monitor_id]
