...
class DeviceBatteryChargingStatusEmulator(DeviceDataEmulator):
    ...
    emulation_modes = {
        ...
        DeviceEmulationModes.LOW: emulation_modes.ChargingDeviceBatteryChargingStatusEmulator,
        DeviceEmulationModes.NORMAL: emulation_modes.DischargingDeviceBatteryChargingStatusEmulator,
