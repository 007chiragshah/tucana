...
class PatientMonitorDetailSchema(BaseModel):
    ...
    def from_data_model(cls, patient_monitor: PatientMonitor) -> "PatientMonitorDetailSchema":
        ...
        return cls.construct(
            ...
            emulators=emulators,
            patient=PatientSchema(
                primary_identifier=patient_monitor.patient.primary_identifier,
                given_name=patient_monitor.patient.given_name,
                family_name=patient_monitor.patient.family_name,
                gender=patient_monitor.patient.gender,
                birth_date=patient_monitor.patient.birth_date,
            )
