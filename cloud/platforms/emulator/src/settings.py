...
class Settings(BaseSettings):
    ...
    BP_MESSAGE_INTERVAL_IN_SECONDS: Decimal = Decimal("300.0")
    # HR
    # internal rate at which the monitor will send heart rate data
    HR_MESSAGE_INTERVAL_IN_SECONDS: Decimal = Decimal("10.0")
    ...
    PULSE_MESSAGE_INTERVAL_IN_SECONDS: Decimal = Decimal("300.0")
    ...
    TEMPERATURE_MESSAGE_INTERVAL_IN_SECONDS: Decimal = Decimal("12.0")
    ...
    RR_WAVEFORM_INTERVAL_IN_SECONDS: Decimal = Decimal("0.5")
    RR_MESSAGE_INTERVAL_IN_SECONDS: Decimal = Decimal("8")
