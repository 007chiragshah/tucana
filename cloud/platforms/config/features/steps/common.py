...
def generate_valid_jwt_token() -> str:
...
def generate_invalid_valid_jwt_token() -> str:
...
def step_impl(context):
    context.internal_token = generate_valid_jwt_token()
...
def step_impl(context):
    context.internal_token = generate_invalid_valid_jwt_token()
    context.request["headers"] = {"Authorization": context.internal_token}
