...
class PlanPatientEncounter(Event[Encounter]):
...
class StartPatientEncounter(Event[Encounter]):
...
class CancelPatientEncounter(Event[Encounter]):
...
class CompletePatientEncounter(Event[Encounter]):
...
class DismissPatientEncounter(Event[Encounter]):
