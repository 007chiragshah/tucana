...
class CreateDeviceEvent(Event[Device]):
...
class DeleteDeviceEvent(Event[Device]):
...
class UpdateDeviceInfoEvent(Event[Device]):
...
class UpdateDeviceConfigEvent(Event[Device]):
...
class AssignDeviceLocationEvent(Event[Device]):
...
class UnassignDeviceLocationEvent(Event[Device]):
...
class CreateVitalRangeEvent(Event[VitalRange]):
...
class DeleteVitalRangeEvent(Event[VitalRange]):
    display_name: str = "Device information updated"
...
class CreateDeviceAlertEvent(Event[DeviceAlert]):
...
class UpdateDeviceAlertEvent(Event[DeviceAlert]):
...
class DeleteDeviceAlertEvent(Event[DeviceAlert]):
...
class DeviceAlertsUpdatedEvent(Event[DeviceAlert]):
...
class BackfillDeviceVitalRangeEvent(Event[VitalRange]):
    display_name: str = "Vital Range Created"
    event_type: str = "VITAL_RANGE_CREATED_EVENT"
    is_backfill: str = "1"
